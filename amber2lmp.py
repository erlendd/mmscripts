...
# For prismatic unit cell is sufficient to se (x,y,z)lo as min and (x,y,z)hi as max
...
# This part was missing
	...
	print 'Reading Scee_Scale_Factor and scnd_scale_factor...'
        self.SCEE = []
        for i in range(self.NPTRA):
            self.SCEE.append(eval(Pop(Item_list,0)))

	print 'Reading Scnd_Scale_Factor...'
        self.SCND = []
        for i in range(self.NPTRA):
            self.SCND.append(eval(Pop(Item_list,0)))
...
# This part is not needed and not used in the Lammps input file
